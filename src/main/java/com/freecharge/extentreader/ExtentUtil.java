package com.freecharge.extentreader;
...
public class ExtentUtil {
    ...
    public static ExtentReports createReporter(String fileName) {
        ...
        extentHtmlReporter.config().setReportName("UI Automation Report");
        extentHtmlReporter.config().setDocumentTitle("Freecharge - Axis Bank");
